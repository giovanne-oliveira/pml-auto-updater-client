 ...
 * PHPMyLicense v4.x
 *
 * https://phpmylicense.us/v4
 *
 * Fork of: https://github.com/VisualAppeal/PHP-Auto-Update
 *
 * AutoUpdate.php
 */
...
use PHPMyLicense\Exceptions\DownloadException;
use PHPMyLicense\Exceptions\ParserException;

class AutoUpdate
{

    /**
     * Script Version - DO NOT CHANGE! MAY BREAK ENTIRE SYSTEM
     * @var string
     */
    ...
    /**
     * Set the PHPMyLicense URL
     *
     * @param string $updateUrl
     * @return $this
     */
    public function setPMLUrl($updateUrl)
    {
        $this->updateUrl = $updateUrl.'/api/checkForUpdate';
    ...
    /**
     * Set PHPMyLicense Activation Code
     * Needed for client authentication with server
